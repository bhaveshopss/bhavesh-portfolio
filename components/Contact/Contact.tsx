  ...
  return (
    <>
      <section className="relative z-10 py-12 overflow-hidden bg-gradient-to-b from-transparent to-gray-200 dark:to-black transition-colors duration-500" id="contact">
        <div className="container mx-auto px-4 text-center">
          <MotionH2
            ...
            className="font-display text-5xl md:text-8xl font-bold text-gray-900 dark:text-white mb-6 tracking-tighter uppercase"
          >
            <MotionSpan
          ...
          <MotionDiv
            ...
            className="w-24 h-1 bg-gradient-to-r from-primary via-accent-purple to-primary mx-auto mb-8 rounded-full"
          />
          ...
          <MotionA
            ...
            whileTap={{ scale: 0.95 }}
            className="cursor-interactive px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-black font-bold uppercase tracking-widest rounded-button hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:text-white transition-all inline-block mb-10 shadow-lg hover:shadow-glow-primary"
          >
            Launch Command
          </MotionA>
      ...
      <MotionDiv
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.6, ease: [0.4, 0, 0.2, 1] }}
        className="relative z-10 bg-gray-100 dark:bg-black py-6 border-t border-gray-200 dark:border-white/10 transition-colors duration-500"
        as="footer"
      >
        <div className="container mx-auto px-4 text-center">
