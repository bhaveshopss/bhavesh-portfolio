...
export const timeline: TimelineStage[] = [
  {
    ...
    description:
      'Ran multi-client cloud infrastructure as managed service — the foundation everything else was built on.',
    points: [
...
export const posts: Post[] = [
  {
    ...
    readTime: '5 min',
    excerpt:
      'Deploying lightweight K3s clusters across 50+ locations teaches you that the speed of light is the only hard limit when coordinating distributed state.',
...
export const aboutParagraphs = [
  ...
  'On the reliability side, I ran multi-client estates across AWS, Azure, and GCP — 99.9% uptime, 200+ resources as code, FinOps discipline that cut spend 20%. On the AI side, I shipped LLM and RAG infrastructure carrying 1,000+ daily requests, and built agents that triage pipeline failures and resolve incidents before a human opens a dashboard.',
